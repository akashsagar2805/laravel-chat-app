            ...
            >
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="h-screen w-screen">
                        ...
                        >
                            <Dialog.Panel className="flex flex-col w-full h-full transform
                        overflow-hidden bg-slate-800 text-left align-middle shadow-xl
                        transition-all">
                                <button
                                    onClick={close}
                                    className="absolute right-3 top-3 w-10 h-10 rounded-full
                                hover:bg-black/10 transition flex items-center justify-center
                                text-gray-100 z-40"
                                >
                                ...
                                <div className="relative group h-full">
                                    {currentIndex > 0 && (
                                        ...
                                        flex items-center justify-center w-16 h-16 left-4 top-1/2 -transition-y-1/2
                                    ...
                                    {currentIndex <
                                        previewableAttachments.length - 1 && (
                                            <div
                                                onClick={next}
                                                className="absolute opacity-100 text-gray-100 cursor-pointer
                                            flex items-center justify-center w-16 h-16 right-4 top-1/2 -transition-y-1/2
                                            rounded-full bg-black/50 z-30"
                                            >
