...
class User extends Authenticatable
{
    ...
    {
        $userId = $user->id;
        $query = User::select(['users.*', 'messages.message as last_message', 'messages.created_at as last_messsage_date'])
    ...
    public function toConversationArray()
    {
        return [
            ...
            'last_message_date' => $this->last_messsage_date ? ($this->last_messsage_date . ' UTC') : null,
        ];
    }
}
